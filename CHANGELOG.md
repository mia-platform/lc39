...
- fastify to version 3.7.0
- fastify-metrics to version 6.0.2
- fastify-plugin to version 3.0.0
- fastify-sensible to version 3.0.1
- fastify-swagger to version 3.4.0
