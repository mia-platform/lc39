...
async function launchFastify(file, options, address) {
  ...
  const openApiSpecification = lget(serviceModule.swaggerDefinition, 'openApiSpecification', 'openapi').toLowerCase()
  ...
  fastify
    ...
    .register(fastifySwagger, {
      [openApiSpecification]: swaggerDefinition(serviceModule.swaggerDefinition, openApiSpecification),
      exposeRoute: true,
...
module.exports = async function launch(file, options, otelSdk) {
